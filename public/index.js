...
// Aspect ratio (H/W)
// 1.048338
var asteroidTexture2 = PIXI.Texture.fromImage("http://localhost:8080/asteroid2.png", true, PIXI.scaleModes.NEAREST);
var asteroid2 = new Rectangle(asteroidTexture2, 0.5, 0.5, 700, 300, 95, (95 / 1.048338));

// Smallest asteroid 
// Aspect ratio (H/W)
// 1.128
var asteroidTexture3 = PIXI.Texture.fromImage("http://localhost:8080/asteroid3.png", true, PIXI.scaleModes.NEAREST);
...
var texture = PIXI.Texture.fromImage("http://localhost:8080/player.png", true);
// var textureJet = PIXI.Texture.fromImage("http://i.imgur.com/q30dfSV.png", true, PIXI.scaleModes.NEAREST);
var textureJet = PIXI.Texture.fromImage("http://localhost:8080/playerjet.png", true, PIXI.scaleModes.NEAREST);
